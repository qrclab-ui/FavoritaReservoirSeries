...
ETS & \texttt{code/baselines/ets/} & modelo de nível, tendencia e sazonalidade aditiva \\
Prophet & \texttt{code/baselines/prophet/} & decomposicao de tendencia, sazonalidade e regressor exógeno \\
XGBoost & \texttt{code/classical/xgboost/} & aprendizado tabular sobre lags e médias móveis \\
