...
\bottomrule\noalign{}
\endlastfoot
Seasonal Naive & \texttt{code/baselines/seasonal\_naives/} & repete a última semana observada \\
...
\subsubsection{6.2 XGBoost e Prophet como faixa intermediária forte}\label{62-xgboost-e-prophet-como-faixa-intermediuxe1ria-forte}
