...
Modelo \& Implementação \& Ideia central \textbackslash{}
\textbackslash midrule
Seasonal Naive \& \textbackslash path\{code/baselines/seasonal\_naives/\} \& repete a última semana observada \textbackslash{}
ETS \& \textbackslash path\{code/baselines/ets/\} \& modelo de nível, tendencia e sazonalidade aditiva \textbackslash{}
Prophet \& \textbackslash path\{code/baselines/prophet/\} \& decomposicao de tendencia, sazonalidade e regressor exógeno \textbackslash{}
XGBoost \& \textbackslash path\{code/classical/xgboost/\} \& aprendizado tabular sobre lags e médias móveis \textbackslash{}
LSTM \& \textbackslash path\{code/classical/lstm/\} \& rede recorrente treinada por gradiente \textbackslash{}
RC \& \textbackslash path\{code/rc/\} \& reservatório fixo e readout linear \textbackslash{}
QRC \& \textbackslash path\{code/qrc/\} \& reservatório quântico implementado com Qiskit \textbackslash{}
