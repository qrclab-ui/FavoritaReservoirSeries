...
\section{A intuição: um reservatório e uma memória dinâmica}\label{2-a-intuiuxe7uxe3o-um-reservatuxf3rio-e-uma-memuxf3ria-dinuxe2mica}
...
\subsection{Os ingredientes da atualização}\label{31-os-ingredientes-da-atualizauxe7uxe3o}
...
\subsection{Primeiro passo: combinar passado e entrada}\label{32-primeiro-passo-combinar-passado-e-entrada}
...
\subsection{Segundo passo: obter o estado candidato}\label{33-segundo-passo-obter-o-estado-candidato}
...
\subsection{Terceiro passo: misturar memória e atualização nova}\label{34-terceiro-passo-misturar-memuxf3ria-e-atualizauxe7uxe3o-nova}
...
\subsection{A equação completa do reservatório}\label{35-a-equauxe7uxe3o-completa-do-reservatuxf3rio}
...
\subsection{Como a previsão sai do estado interno}\label{36-como-a-previsuxe3o-sai-do-estado-interno}
