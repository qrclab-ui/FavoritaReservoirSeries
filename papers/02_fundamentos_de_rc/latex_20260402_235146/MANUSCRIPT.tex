...
No projeto, o vetor de entrada sequencial e construido em \texttt{code/common/sequential\_features.py} com sete componentes:
...
\pandocbounded{\includegraphics[keepaspectratio,alt={Heatmap dos estados internos do reservatorio classico no recorte adotado no Favorita.}]{computational_results_20260402_222902/rc_state_heatmap.png}}
...
Em outras palavras, RC constroi uma base dinamica de features sem precisar enumerar manualmente toda a interacao temporal.
...
\item
  verificar como o vetor \texttt{u\_t} e construido;
\item
...
RC ja esta completamente formulado no contexto do projeto. Temos uma definicao matematica, uma implementacao concreta e artefatos intermediarios que mostram a representacao temporal em acao. O proximo passo natural e colocar esse modelo em confronto com um baseline forte, medindo o que ele realmente entrega no recorte adotado no Favorita.
