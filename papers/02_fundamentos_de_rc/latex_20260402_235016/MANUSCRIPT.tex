...
\pandocbounded{\includegraphics[keepaspectratio,alt={Heatmap dos estados internos do reservatorio classico no recorte do Favorita.}]{computational_results_20260402_222902/rc_state_heatmap.png}}
...
RC ja esta completamente formulado no contexto do projeto. Temos uma definicao matematica, uma implementacao concreta e artefatos intermediarios que mostram a representacao temporal em acao. O proximo passo natural e colocar esse modelo em confronto com um baseline forte, medindo o que ele realmente entrega no recorte do Favorita.
