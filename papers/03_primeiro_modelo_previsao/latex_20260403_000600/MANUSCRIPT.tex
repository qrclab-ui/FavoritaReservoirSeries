\documentclass[12pt]{article}
        ...
        \sloppy
        \title{Primeiro pipeline reproduzível: previsão de demanda no Favorita com baselines e RC}
        \author{}
        \address{}
        \begin{document}
...
A implementação é curta exatamente porque sua função pedagogica e clara:
...
O RC funciona de ponta a ponta: carrega dados, constroi representação, treina readout e produz previsões. Mas funcionar não e o mesmo que vencer. O artigo faz questão de manter essa distinção.
...
O primeiro pipeline reproduzível da série esta fechado. O baseline sazonal venceu, o RC funcionou sem vencer e o leitor já tem um experimento concreto para estudar, modificar e rerodar. Isso é exatamente o que um artigo didatico deveria entregar neste ponto: menos promessas vagas e mais reprodução concreta.
