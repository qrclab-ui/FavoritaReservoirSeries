...
Esse split é fundamental. Se ele mudar entre os modelos, a comparação deixa de ser confiavel.
...
A implementação é curta exatamente porque sua função pedagogica é clara:
...
\pandocbounded{\includegraphics[keepaspectratio,alt={Comparação direta entre o baseline sazonal e o RC no bloco de teste.}]{computational_results_20260402_222902/baseline_vs_rc_overlay.png}}
...
\subsubsection{8.3 Reprodutibilidade é uma conquista em si}\label{83-reprodutibilidade-uxe9-uma-conquista-em-si}
...
Essa progressao é importante porque impede um salto artificial do "primeiro RC" diretamente para o "QRC final".
