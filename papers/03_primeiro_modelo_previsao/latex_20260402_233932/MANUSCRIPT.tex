...
Em series temporais, um baseline sazonal simples pode ser surpreendentemente competitivo. Isso vale especialmente quando o sinal semanal e forte, como no caso de bebidas no recorte Favorita.

\subsubsection{8.2 RC nao deve ser tratado como magia}\label{82-rc-nao-deve-ser-tratado-como-magia}

O RC funciona de ponta a ponta: carrega dados, construi representacao, treina readout e produz previsoes. Mas funcionar nao e o mesmo que vencer. O artigo faz questao de manter essa distinção.
