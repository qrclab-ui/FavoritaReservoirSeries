...
\section{\texorpdfstring{4. Passo 2: executar o baseline \texttt{Seasonal\ Naive}}{Passo 2: executar o baseline Seasonal Naive}}}\label{4-passo-2-executar-o-baseline-seasonal-naive}
