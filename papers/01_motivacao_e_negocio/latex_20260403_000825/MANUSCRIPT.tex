...
em que \(R_t\) e a quantidade planejada para reposição e \(SS_t\) e um estoque de segurança. Mesmo sem modelar toda a política de inventário, a equação deixa claro o ponto principal: melhorar \(\hat{y}_{t+1}\) melhora a qualidade da decisão.
