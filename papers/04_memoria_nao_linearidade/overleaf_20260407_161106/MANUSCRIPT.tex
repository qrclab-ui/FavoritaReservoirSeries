\documentclass[12pt]{article}
            ...
            \fancyhf{}
            \fancyfoot[R]{\thepage}
            \fancyfoot[L]{SANTOS, Anderson F. P. dos — Memória e não linearidade em RC}
            \renewcommand{\headrulewidth}{0pt}
            \renewcommand{\footrulewidth}{0.4pt}
            \sloppy
            \title{Memória e não linearidade em RC}
...
Essa expressão mostra a intuição correta: o estado atual e uma superposicao ponderada do passado. A velocidade com que o passado "desaparece" depende da matriz efetiva \(A\), logo depende de \texttt{spectral\_radius} e \texttt{leak\_rate}.
...
\section{Não linearidade: por que a série não cabe em uma regra única}\label{3-nuxe3o-linearidade-por-que-a-suxe9rie-nuxe3o-cabe-em-uma-regra-uxfanica}
...
\section{Como ler os hiperparâmetros do RC no código}\label{6-como-ler-os-hiperparuxe2metros-do-rc-no-cuxf3digo}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=\linewidth,keepaspectratio]{computational_results_20260402_222902/rc_sensitivity_summary.png}
\caption{Resumo visual das varreduras de hiperparâmetros do RC no recorte adotado no Favorita.}
\end{figure}
