...
Esse resultado ensina uma licao importante: uma memoria mais longa não e automaticamente melhor. Se a série responde fortemente a promoção e sazonalidade semanal, uma resposta um pouco mais rapida pode ajudar.
...
\subsection{6. Como ler os hiperparametros do RC no código}\label{6-como-ler-os-hiperparametros-do-rc-no-cuxf3digo}
