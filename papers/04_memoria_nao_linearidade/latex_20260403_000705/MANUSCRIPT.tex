...
\subsection{2. Memória: o passado precisa continuar presente}\label{2-memuxf3ria-o-passado-precisa-continuar-presente}
...
Essa expressao mostra a intuição correta: o estado atual é uma superposicao ponderada do passado. A velocidade com que o passado "desaparece" depende da matriz efetiva \(A\), logo depende de \texttt{spectral\_radius} e \texttt{leak\_rate}.
...
Esse resultado ensina uma licao importante: uma memória mais longa não e automaticamente melhor. Se a série responde fortemente a promoção e sazonalidade semanal, uma resposta um pouco mais rapida pode ajudar.
...
\subsection{3. Não linearidade: por que a série não cabe em uma regra unica}\label{3-nuxe3o-linearidade-por-que-a-suxe9rie-nuxe3o-cabe-em-uma-regra-unica}
