...
O circuito elemental do projeto aplica:
...
A ponte entre RC classico e QRC esta pronta. O leitor agora tem um mapa formal, implementacional e experimental do salto para o quantico. O artigo final vai aproveitar exatamente essa ponte para executar e interpretar o QRC no recorte Favorita, comparando \texttt{14x7}, \texttt{8x5} e os melhores modelos classicos.
