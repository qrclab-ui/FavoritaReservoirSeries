...
\tightlist
\item
  \texttt{8x5} usa \texttt{24} observáveis é um vetor final com \texttt{1\ +\ 4\ +\ 24\ =\ 29} features;
\item
  \texttt{14x7} usa \texttt{42} observáveis é um vetor final com \texttt{1\ +\ 4\ +\ 42\ =\ 47} features.
\end{itemize}
...
Essa implementação é importante pedagogicamente porque mostra que o QRC do projeto não é uma caixa preta: ele é um pipeline legivel, curto e comparavel ao RC clássico.
